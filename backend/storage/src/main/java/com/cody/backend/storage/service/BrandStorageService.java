...
public class BrandStorageService {
    ...
    public List<BrandRequest> deleteBrands(List<BrandRequest> brands) throws EmptyResultDataAccessException, EntityNotFoundException, IllegalStateException, IllegalArgumentException {
    ...
    public List<BrandRequest> updateBrands(List<BrandRequest> brands) throws EntityNotFoundException, OptimisticLockingFailureException, IllegalStateException {
