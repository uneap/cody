...
- [x] 테스트
    ...
    - [x] store-cache 모듈 unit test 추가
        - [x] 1,2,3 별 기능 test 추가
        - [x] 상품 삭제, 업데이트, 추가 시 redis에 잘 적재되는지 test
        - [x] 브랜드 업데이트, 추가 시 redis에 잘 적재되는지 test
        - [x] 브랜드 삭제 시 캐시에서 해당 브랜드 상품들 삭제 잘 되는지 test

# redis 키 설명

brandId:$id -> 브랜드 아이디를 키로 브랜드 정보 저장
![image](https://github.com/uneap/cody/assets/25525648/cd3c99c3-99b9-402b-9610-5c06d354cf66)


LowestPrice:brandId:$id: opsForValue -> 브랜드 아이디를 키로 카테고리 별로 가장 낮은 가격 상품 리스트
![image](https://github.com/uneap/cody/assets/25525648/ba230706-4d2c-40c7-b591-07a7b4e015c6)


priceBrand:  zSet -> zrange를 통해 가장 낮은 가격으로 판매 중인 브랜드를 알 수 있음

![image](https://github.com/uneap/cody/assets/25525648/b3099fe9-62b2-4472-8a91-0804f6ed991c)


price:brandId:$id:categoryId:$id  -> zrange를 통해 brandId와 categoryId가 같은 상품 중 가장 낮은 가격의 상품을 알 수 있음.
![image](https://github.com/uneap/cody/assets/25525648/b94c112a-9e39-4454-a60b-02a0de89515f)


LowestFullCategory -> 모든 카테고리의 낮은 가격과 브랜드 번호 저장
![image](https://github.com/uneap/cody/assets/25525648/c8736c27-786a-4b04-a7d0-d3dee30d542d)


LowestPrice:category:$id -> zrange 0 0을 통해 카테별 가장 낮은 상품을 가진 brand를 알 수 있음.
![image](https://github.com/uneap/cody/assets/25525648/abe7f9ea-9c88-4c3f-8ceb-022ccfe9a991)


highestPrice:category:$id -> reverseZrange 0 0 을 통해 가장 높은 상품을 가진 brand를 알 수 있음.

![image](https://github.com/uneap/cody/assets/25525648/506b08ae-9597-4066-811a-3000cb18e51e)
...
unique (category_id, brand_id, id)
)
```
